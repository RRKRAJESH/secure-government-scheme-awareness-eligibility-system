...
app = FastAPI(
    title="Secure Government Scheme Awareness and Eligibility System",
    root_path=f"/api/{version}/backend",
    lifespan=lifespan,
)

app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # React dev server and production front-end
...
app.include_router(
    grievances_router, prefix="/grievances", tags=["Grievances & Thoughts"]
)
app.include_router(
